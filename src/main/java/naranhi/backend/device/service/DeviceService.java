package naranhi.backend.device.service;
...
import naranhi.backend.device.repository.DeviceRepository;
import naranhi.backend.device.repository.MemberDeviceRepository;
import naranhi.backend.device.repository.mongo.DeviceStatusChangeLogRepository;
