...
import naranhi.backend.domain.safety.dto.EventTypeResponse;
...
public class NotificationResponse {
    ...
    public record DeviceDetail(
            Long deviceId,
            String deviceName,
            naranhi.backend.domain.notification.entity.ComponentType componentType,
            naranhi.backend.domain.notification.entity.ComponentStatus beforeStatus,
            naranhi.backend.domain.notification.entity.ComponentStatus currentStatus,
            String description
    ) {
